...
ExecStart=/usr/bin/node --inspect server.js
Restart=always
RestartSec=10
...
echo "• Run:     sudo $APP_DIR/$SCENARIO.sh"
echo "• Note:    Optional --assets <path>, defaults to /etc/situational-awareness/assets.json"
echo ""
